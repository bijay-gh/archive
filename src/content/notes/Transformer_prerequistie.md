...
title: Transformer Prerequisite
description: What you should know before diving into transformer architecture
pubDate: 2025-12-01
subject: "Transformer"
tags: ["transformer", "prerequisite", "text-representation", "embedding"]
draft: false
...
If i ever write a note on text representation it will be linked [here]()

If you want to skip all of the above..... Please consider reading [<span style="border: 2px solid #c4bbbbff; border-radius: 20px; padding: 2px 8px;">THIS</span>](/notes/summary_of_text_representation)
This is just some ai generated content i compiled and put here to roughly understand the context of text representation.

NEXT_UP.........[<span style="border: 2px solid #c4bbbbff; border-radius: 20px; padding: 2px 8px;">TRANSFORMER</span>](/notes/transformer_0)